...
#[proto_query(
    ...
    response_type = QueryCalculateTxFeesResponse
)]
pub struct QueryCalculateTxFeesRequest {
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, Eq, ::prost::Message, ::schemars::JsonSchema, CosmwasmExt)]
#[proto_message(type_url = "/provenance.flatfees.v1.QueryCalculateTxFeesResponse")]
pub struct QueryCalculateTxFeesResponse {
...
impl<'a, Q: cosmwasm_std::CustomQuery> FlatfeesQuerier<'a, Q> {
    ...
    pub fn calculate_tx_fees(
        ...
        gas_adjustment: f32,
    ) -> Result<QueryCalculateTxFeesResponse, cosmwasm_std::StdError> {
